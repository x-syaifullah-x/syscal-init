...
//         sys_c_write_n(STDOUT_FILENO, ret);
//         SYS_C_WRITE(STDOUT_FILENO, "\n");
//         sys_c_exit(0);
//     }
...
//     sys_c_write_n(STDOUT_FILENO, fd_1);

//     SYS_C_WRITE(STDOUT_FILENO, "\n");

//     SYS_C_WRITE(STDOUT_FILENO, "FD_2: ");
//     sys_c_write_n(STDOUT_FILENO, fd_2);
...
//     sys_c_write_n(STDOUT_FILENO, st.st_size);
// }
...
//     SYS_C_WRITE(STDOUT_FILENO, "\nRow: ");
//     sys_c_write_n(STDOUT_FILENO, w.ws_row);

//     SYS_C_WRITE(STDOUT_FILENO, "\nCol: ");
//     sys_c_write_n(STDOUT_FILENO, w.ws_col);
// }
...
void _start() {
    ...
    const int argc = *stack;
    const char **argv = (const char **)(stack + 1);

    for (int i = 0; i < argc; i++) {
        sys_c_write(STDOUT_FILENO, argv[i], strlen(argv[i]));
        sys_c_write(STDOUT_FILENO, "\n", 1);
    }
